    ...
    >
      ...
      <a-form-item field="scoringStrategy" label="评分策略">
        ...
        >
          ...
          />
          <!-- 这里的key和value对应该枚举类
          将，遍历的结果绑定到选项上，传递给数据库APP_SCORING_STRATEGY_MAP-->
        </a-select>
      </a-form-item>
      <a-form-item>
...
const handleSubmit = async () => {
  ...
  // 如果是修改
  if (props.id) {
    // 传入一个对象，对象中包含id和form.value
    // 对应editAppUsingPost(body: API.AppEditRequest, options?: { [key: string]: any })

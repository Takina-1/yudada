...
public class AppController {
    ...
    @Resource//默认是按照名字注入，没找到的话退回按照类型注入
     ...
     * 创建应用
     *
     * @param appAddRequest//声明参数
     * @param request
     * @return
     */
    @PostMapping("/add")
//  @RequestBody AppAddRequest appAddRequest这里的appRequeset是传过来的dto
    /*
    * 将 HTTP 请求体（Request Body）中的内容绑定到 方法参数 上，
    * 通常用于接收前端传递的 JSON/XML 等结构化数据。
    * 表示将请求体中的 JSON 数据自动反序列化为 AppAddRequest 对象
    *
    *
    * */
